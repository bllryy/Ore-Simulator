...
import bllry.oresim.gui.screens.InteractionScreen;
import bllry.oresim.settings.StringMapSetting;
...
public class InteractionMenu extends Module {
    ...
    public InteractionMenu() {
        super(bllryAddon.CATEGORY, "interaction-menu", "An interaction screen when looking at an entity.");
