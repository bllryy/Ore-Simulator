package bllry.oresim.modules;

import bllry.oresim.bllryAddon;
import bllry.oresim.events.PlayerRespawnEvent;
import bllry.oresim.events.SeedChangedEvent;
import bllry.oresim.utils.Ore;
import bllry.oresim.utils.seeds.Seed;
...
public class OreSim extends Module {
    ...
    public OreSim() {
        super(bllryAddon.CATEGORY, "ore-sim", "Xray on crack.");
